...
import { EmbSegmentedControl, type SegmentedControlOption } from "./emb-segmented-control.js";

describe("emb-segmented-control", () => {
  ...
  it("renders radio options and updates the host value", async () => {
    const element = document.createElement("emb-segmented-control") as EmbSegmentedControl;
