...
import { EmbNavigationRailItem } from "../navigation-rail-item/emb-navigation-rail-item.js";
 ...
 *
 * @slot - `emb-navigation-rail-item` children.
 */
export class EmbNavigationRail extends LitElement {
  static styles = css`
    :host {
  ...
  private get railItems(): EmbNavigationRailItem[] {
    return Array.from(this.children).filter((child): child is EmbNavigationRailItem => child instanceof EmbNavigationRailItem);
  }
}
