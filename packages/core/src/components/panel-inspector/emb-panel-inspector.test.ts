...
import { EmbPanelInspector } from "./emb-panel-inspector.js";

describe("emb-panel-inspector", () => {
  it("renders heading copy and footer content", async () => {
    const element = document.createElement("emb-panel-inspector") as EmbPanelInspector;
