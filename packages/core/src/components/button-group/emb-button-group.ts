...
const groupedButtonTags = new Set(["EMB-BUTTON", "EMB-ICON-BUTTON"]);
const buttonRadiusVars = [
  "--emb-button-border-start-start-radius",
  "--emb-button-border-start-end-radius",
  "--emb-button-border-end-start-radius",
  "--emb-button-border-end-end-radius"
] as const;

export class EmbButtonGroup extends LitElement {
  static styles = css`
    :host {
  ...
  private syncItems(): void {
    ...
    items.forEach((item, index) => {
      ...
      item.style.setProperty("--emb-button-border-start-start-radius", startStartRadius);
      item.style.setProperty("--emb-button-border-start-end-radius", startEndRadius);
      item.style.setProperty("--emb-button-border-end-start-radius", endStartRadius);
      item.style.setProperty("--emb-button-border-end-end-radius", endEndRadius);
    });
  }
