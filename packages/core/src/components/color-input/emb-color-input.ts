...
export class EmbColorInput extends FormAssociatedElement {
  static styles = css`
    :host {
      display: inline-block;
      width: var(--emb-field-inline-size, min(100%, 160px));
      max-width: 100%;
      min-width: 0;
      color: var(--fg);
    }
    ...
    .swatch {
      ...
      background-color: var(--emb-color-input-value, #4f46e5);
  ...
  protected override render() {
    return html`
      <div class="surface" part="surface" style=${`--emb-color-input-value: ${this.value};`}>
        <input
          part="control"
