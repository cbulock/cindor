 ...
 */
export class EmbInlineEdit extends LitElement {
  static styles = css`
    :host {
          ...
          ? html`
              <div class="editor" part="editor">
                ...
                <div class="actions" part="actions">
                  <emb-button part="save-button" type="button" @click=${this.handleSave}>Save</emb-button>
                  <emb-button part="cancel-button" type="button" variant="ghost" @click=${this.handleCancel}>Cancel</emb-button>
                </div>
              </div>
            `
          : html`
