...
export class EmbCalendar extends FormAssociatedElement {
  static styles = css`
    :host {
      display: inline-grid;
      gap: var(--space-3);
    ...
    return html`
      <div class="surface" part="surface">
        <div class="header" part="header">
          ...
          ></emb-icon-button>
          <div class="month-titles" part="month-titles" style=${`--emb-calendar-month-count:${visibleMonths.length};`}>
            ${visibleMonths.map(
        ...
        <div class="months" part="months" style=${`--emb-calendar-month-count:${visibleMonths.length};`}>
