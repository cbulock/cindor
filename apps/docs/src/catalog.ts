...
export const componentCatalog: ComponentDoc[] = [
  ...
  defineComponent("tree-grid", "Tree Grid", "Component", "Data", "hierarchical table", "Nested collection table that keeps branches visible while rows expand and collapse inline."),
  ...
  defineComponent("transfer-list", "Transfer List", "Component", "Selection", "dual multi-select lists plus Cindor actions", "Move values between available and chosen collections with native list semantics and shared action primitives."),
  ...
  defineComponent("workspace-switcher", "Workspace Switcher", "Component", "Navigation", "searchable workspace picker", "Searchable workspace and project switcher for multi-surface product shells."),
