...
import type { CommandPaletteCommand, FilterBuilderField, JsonViewerValue, KanbanBoardColumn, SegmentedControlOption, StepperStep, WorkspaceSwitcherItem } from "cindor-ui-core";
...
type JsonViewerHost = HTMLElement & {
...
const jsonViewerPreviewData: JsonViewerValue = {
  deployment: {
        ...
        <section class="section roadmap-section">
          ...
          <div class="roadmap-overview">
            <div class="preview-block">
              ...
              <p class="muted"><code>virtual-list</code>, <code>sortable-list</code>, <code>field-array</code>, <code>data-grid</code>, <code>tree-grid</code>, <code>workspace-switcher</code>, <code>json-viewer</code>, <code>markdown-editor</code>, and <code>kanban-board</code> now anchor the current roadmap work. <code>coachmark-tour</code> is the next meaningful gap in that sequence.</p>
            </div>
            <div class="preview-block">
...
function hydrateHomeExamples(): void {
  ...
  const projectScope = root.querySelector<SegmentedControlHost>("#pattern-project-scope");
  if (projectScope) {
    projectScope.options = projectScopeOptions;
